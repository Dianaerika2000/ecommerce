    ...
    <div class="container py-8">
        <div class="grid grid-cols-2 gap-6">
            ...
            <div>
                ...
                <div class="flex">
                    <p class="text-black">Marca: <a class="underline capitalize hover:text-Orange-500" href="">{{$product->brand->name}}</a></p>
                    <p></p>
                </div>
                <p class="text-2xl text-black my-4"> Bs {{$product->price}}</p>
                <div class="bg-white rounded-lg shadow-lg mb-6">
                    <div class="p-4 flex items-center">
                        <span class="flex items-center justify-center h-10 w-10 rounded-full bg-Amber-500">
                          <i class="fas fa-truck text-white"></i>  
                        </span>
                        <div class="ml-4">
                            <p class="text-lg">Se hace envios a todo Bolivia</p>
                            <p>Fecha de entrega: {{Date::now()->addDay(2)->locale('es')->format('l j F')}} </p>
                        </div>
                    </div>
                </div>
            </div>
